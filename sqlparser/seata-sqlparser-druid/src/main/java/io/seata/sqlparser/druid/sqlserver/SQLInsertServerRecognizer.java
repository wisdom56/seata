 ...
 * @author sharajava
 */
public class SQLInsertServerRecognizer extends BaseSQLServerRecognizer implements SQLInsertRecognizer {
     ...
     * @param ast         the ast
     */
    public SQLInsertServerRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
