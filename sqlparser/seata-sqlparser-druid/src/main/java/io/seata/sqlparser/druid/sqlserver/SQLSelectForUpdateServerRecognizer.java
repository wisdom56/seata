 ...
 * @author sharajava
 */
public class SQLSelectForUpdateServerRecognizer extends BaseSQLServerRecognizer implements SQLSelectRecognizer {
     ...
     * @param ast         the ast
     */
    public SQLSelectForUpdateServerRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
