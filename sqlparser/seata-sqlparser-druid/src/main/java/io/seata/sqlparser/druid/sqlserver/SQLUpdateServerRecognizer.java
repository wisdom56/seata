 ...
 * @author sharajava
 */
public class SQLUpdateServerRecognizer extends BaseSQLServerRecognizer implements SQLUpdateRecognizer {
     ...
     * @param ast         the ast
     */
    public SQLUpdateServerRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
